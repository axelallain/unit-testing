...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
    ...
    /** SQLgetSequenceEcritureComptableByAnnee */
    private static String SQLgetSequenceByJournalAndAnnee;
    public void setSQLgetSequenceByJournalAndAnnee(String pSQLgetSequenceByJournalAndAnnee) {
        SQLgetSequenceByJournalAndAnnee = pSQLgetSequenceByJournalAndAnnee;
    }
    @Override
    public SequenceEcritureComptable getSequenceByJournalAndAnnee(String pJournal, Integer pAnnee) throws NotFoundException {
        ...
        vSqlParams.addValue("journal", pJournal);
        vSqlParams.addValue("annee", pAnnee);
        SequenceEcritureComptableRM vRM = new SequenceEcritureComptableRM();
        SequenceEcritureComptable vBean;
        try {
            vBean = vJdbcTemplate.queryForObject(SQLgetSequenceByJournalAndAnnee, vSqlParams, vRM);
        } catch (EmptyResultDataAccessException vEx) {
            throw new NotFoundException("EcritureComptable non trouvée : annee=" + pAnnee + "journal=" + pJournal);
        }
        return vBean;
    }
    ...
    public void upsertSequenceEcritureComptable(SequenceEcritureComptable pSequenceEcritureComptable) {
        NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
        vSqlParams.addValue("journal", pSequenceEcritureComptable.getJournal());
